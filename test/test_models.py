...
def check_vanilla_rnn_with_parameters(logger):
    ...
    try:
        ...
        _input_layer, _hidden_layer, _readout_layer = rnn.recurrent.input_layer, rnn.recurrent.hidden_layer, rnn.readout_layer
...
def check_forward_pass(logger):
    ...
    try:
        ...
        post_activation = rnn.recurrent.activation(a*pre_hidden).detach().numpy()
