...
$$
L_{MSE} = \frac{1}{N} \sum_{i=1}^{N} \left( \hat{y}_i - y_i \right)^2
$$
...
$$
L_{in} = \frac{1}{N_{in} N_{hid}} \sum_{i,j} w_{ij}^2 = \frac{1}{N_{in} N_{hid}} ||W_{in}||_F^2
$$
...
$$
L_{hid} = \frac{1}{N_{hid} N_{hid}} \sum_{i,j} w_{ij}^2 = \frac{1}{N_{hid} N_{hid}} ||W_{hidden}||_F^2
$$
...
$$
L_{out} = \frac{1}{N_{out} N_{hid}} \sum_{i,j} w_{ij}^2 = \frac{1}{N_{out} N_{hid}} ||W_{out}||_F^2
$$
...
$$
L_{fr} = \frac{1}{N_{batch} T N_{hid}} \sum_{b,t,n=0}^{N_{batch}, T, N_{hid}} \left( \hat{y}_{btn} - y_{btn} \right)^2
$$
...
### Firing Rate Regularization (Single Neuron)
#### Definition
...
$$
L_{fr\_std} = \sqrt{\frac{1}{N_{batch} T} \sum_{b,t=0}^{N_{batch}, T} \left( \left( \hat{y}_{bt} - y_{bt} \right)^2 - \mu \right)^2}
$$
$$
